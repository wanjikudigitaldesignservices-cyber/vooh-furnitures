...
export default function Hero() {
  return (
    <section className="relative flex flex-col-reverse md:flex-row min-h-screen pt-[80px] md:pt-0 bg-[var(--color-cream)] overflow-hidden">
      
      {/* Left Content */}
      <div className="w-full md:w-[55%] flex flex-col justify-center px-6 md:px-16 lg:px-24 py-12 md:py-0 z-10">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="max-w-xl mt-4 md:mt-24"
        >
          <span className="font-sans text-[0.7rem] md:text-xs font-bold tracking-[0.2em] text-[var(--color-sage)] uppercase mb-4 md:mb-6 block">
            5 Showrooms Across Kenya
          </span>
          
          <h1 className="font-display text-4xl md:text-6xl lg:text-[4.5rem] leading-[1.1] text-[var(--color-walnut)] font-bold mb-6">
            Furniture That <br className="hidden md:block" /> Tells Your Story.
          </h1>
          
          <p className="font-sans text-base md:text-lg text-[var(--color-charcoal)] opacity-80 mb-8 md:mb-10 leading-relaxed">
          ...
          {/* Trust Bar */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 pt-8 border-t border-[var(--color-walnut)]/10">
            ...
            <div className="flex items-center gap-3 text-[var(--color-charcoal)]">
              ...
              <span className="font-sans text-xs font-medium uppercase tracking-wider">3-Yr Warranty</span>
            </div>
            <div className="flex items-center gap-3 text-[var(--color-charcoal)]">
      ...
      <div className="w-full md:w-[45%] h-[40vh] md:h-full relative overflow-hidden">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent md:bg-gradient-to-l md:from-transparent md:to-black/10"></div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="absolute bottom-6 left-6 md:bottom-12 md:left-[-40px] z-20"
        >
          <Link href="/shop?new=true" className="bg-[var(--color-gold)] text-white px-6 py-3 rounded-full font-sans text-sm font-bold shadow-2xl flex items-center gap-2 hover:pr-4 hover:pl-8 transition-all group border border-white/20">
